function calculateTax(){
        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
               ...
               if (income <= 18500){
                 ...
                 tax = 18550 * 0.10 + (75300 - 18550) * 0.15 + (income - 75300) * 0.25 + (income - 151900) * 0.28;
                 taxRate = 28;
               }//end of else if
               else if (income <= 413350) {
                 tax = 18550 * 0.10 + (75300 - 18550) * 0.15 + (income - 75300) * 0.25 + (income - 151900) * 0.28 +
                 ...
                 taxRate = 33;
                  ...
                  tax = 18550 * 0.10 + (75300 - 18550) * 0.15 + (income - 75300) * 0.25 + (income - 151900) * 0.28 +
                       (income - 231450) * 0.33 + (income - 413350) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 18550 * 0.10 + (75300 - 18550) * 0.15 + (income - 75300) * 0.25 + (income - 151900) * 0.28 +
                       (income - 231450) * 0.33 + (income - 413350) * 0.35 + (income - 466950) * .396;
                  taxRate = 39.6;
               }//end of nested if
          ...
          *******************************************************************************/
             ...
             if (income <= 9275){
                 ...
                 tax = 9275 * 0.10 + (income - 9275) * 0.15 + (income - 37650) * 0.25;
                 taxRate = 25;
               } //end of else if
               else if (income <= 115725) {
                 tax = 9275 * 0.10 + (income - 9275) * 0.15 + (income - 37650) * 0.25 + (income - 75950) * 0.28;
                 taxRate = 28;
               }//end of else if
                 ...
                 taxRate = 33;
                  ...
                  tax = 9275 * 0.10 + (income - 9275) * 0.15 + (income - 37650) * 0.25 + (income - 75950) * 0.28 +
                       (income - 115725) * 0.33 + (income - 206675) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 9275 * 0.10 + (income - 9275) * 0.15 + (income - 37650) * 0.25 + (income - 75950) * 0.28 +
                       (income - 115725) * 0.33 + (income - 206675) * 0.35 + (income - 233475) * .396;
                  taxRate = 39.6;
               }//end of nested if
        ...
        if (income <= 13250){
                 ...
                 tax = 13250 * 0.10 + (income - 13250) * 0.15 + (income - 50400) * 0.25;
                 taxRate = 25;
               } //end of else if
               else if (income <= 210800) {
                 tax = 13250 * 0.10 + (income - 13250) * 0.15 + (income - 50400) * 0.25 + (income - 130150) * 0.28;
                 taxRate = 28;
               }//end of else if
               else if (income <= 413350) {
                 tax = 13250 * 0.10 + (income - 13250) * 0.15 + (income - 50400) * 0.25 + (income - 130150) * 0.28 +
